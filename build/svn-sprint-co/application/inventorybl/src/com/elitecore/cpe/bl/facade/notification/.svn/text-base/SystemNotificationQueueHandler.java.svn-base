...
public class SystemNotificationQueueHandler {
...
//  Queue queue;
  ...
  public SystemNotificationQueueHandler()throws JMSException, NamingException {
	
	String queueJNDI = "queue/SystemNotificationQueue";
...
//		MessageProducer publisher = queueSession.createProducer(queue);
  ...
  public void send(NotificationData dataObj) throws JMSException {
