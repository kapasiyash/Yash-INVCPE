...
//      	  salt = stringBuffer.toString();
//    	  salt += "A";

      StringBuffer buffer = new StringBuffer("             ");

      char charZero = stringBuffer.toString().charAt(0);
      char charOne  = stringBuffer.toString().charAt(1);
...
//      char charOne  = salt.charAt(1);
  ...
  public  static  String crypt(String original)
  {
    ...
    salt = (new StringBuffer()).append(saltChars[Math.abs(randomGenerator.nextInt(1000)) % numSaltChars]).append(saltChars[Math.abs(randomGenerator.nextInt(1000)) % numSaltChars]).toString();
   ...
   */
  public static  boolean matches(String encryptedPassword, String enteredPassword)
  {
