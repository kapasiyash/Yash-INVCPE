...
#
##echo $TMP_CLASSPATH
#echo `date` " Agent Started" >> billPreview.log
#$JAVA_HOME/jre/bin/java -classpath .:"$TMP_CLASSPATH" com.elitecore.billing.agent.BillPreviewAgent $1 >> billPreview.log
#echo `date` " Agent Stopped" >> billPreview.log 2>&1
#
#
#
#
