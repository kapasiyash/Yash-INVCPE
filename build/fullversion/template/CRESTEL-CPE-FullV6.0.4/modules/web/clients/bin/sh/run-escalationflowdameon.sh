...
##echo $TMP_CLASSPATH
#
#echo `date` " Agent Started" >> escalationFlowDaemon.log
#$JAVA_HOME/jre/bin/java -classpath .:"$TMP_CLASSPATH" com.elitecore.billing.agent.EscalationFlowDameon  >> escalationFlowDaemon.log
#echo `date` " Agent Stopped" >> escalationFlowDaemon.log 2>&1
#
#
#
#
