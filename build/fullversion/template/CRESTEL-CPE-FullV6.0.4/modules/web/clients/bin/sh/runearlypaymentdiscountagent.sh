#!/bin/sh
# FileName - runearlypaymentdiscountagent.sh
...
#$JAVA_HOME/jre/bin/java -classpath .:"$TMP_CLASSPATH" com.elitecore.billing.agent.EarlyPaymentDiscountAgent >> earlyPaymentDiscount.log
#echo `date` " Agent Stopped" >> earlyPaymentDiscount.log 2>&1
#
#
#
#
