...
##echo $TMP_CLASSPATH
#
#echo `date` " Agent Started" >> specialOffer.log
#$JAVA_HOME/jre/bin/java -classpath .:"$TMP_CLASSPATH" com.elitecore.billing.agent.SpecialOfferAgent  >> billAlert.log
#echo `date` " Agent Stopped" >> specialOffer.log 2>&1
#
#
#
#
