...
##echo $TMP_CLASSPATH
#
#echo `date` " Agent Started" >> billSurcharge.log
#$JAVA_HOME/jre/bin/java -classpath .:"$TMP_CLASSPATH" com.elitecore.billing.agent.BillSurchargeAgent >> billSurcharge.log
#echo `date` " Agent Stopped" >> billSurcharge.log 2>&1
#
#
#
#
