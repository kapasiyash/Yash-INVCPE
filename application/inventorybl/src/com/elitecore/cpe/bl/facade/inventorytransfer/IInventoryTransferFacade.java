...
public interface IInventoryTransferFacade {
	...
	public void acceptRejectedTransferInventory(PartialAcceptRejectTransferOrderVO transferOrderVO,IBLSession blSession) throws CreateBLException;
	...
	public InventoryVO checkInventoryForAcceptRejectedInventory(String inventoryNumber, String orderNumber) throws SearchBLException;
}
