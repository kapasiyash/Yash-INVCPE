...
public class ViewTransferInventoryComposer extends BaseModuleComposer {
	...
	public void afterCompose(Window comp) throws ModuleInitializationException {
		...
		if(arg.get("FROMWHNAME")!=null) {
			fromWH = (String) arg.get("FROMWHNAME");
		}
		if(arg.get("TOWHNAME")!=null) {
			toWH = (String) arg.get("TOWHNAME");
		}
	...
	public void onClick$btnDownload(Event event){
		...
		searchTransferInventory.setFromWarehouseName(fromWH);
		searchTransferInventory.setToWarehouseName(toWH);
